...
let levelOne = [
    ...
    play_btn.addEventListener('click', () => {
        (function setSoldiersContext() {
            ...
            if(document.getElementById('sentence') == undefined) return;
            sentence.textContent = levelOne[randomSentence];
        })();
        // TRANSLATE AMOUNT OF WORDS OF A SENTENCE INTO SOLDIER'S COUNTER SECONDS + 1 (av.person reads 3 words in 1 second)
